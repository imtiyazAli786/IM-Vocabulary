export function getAiConfig() {
  ...
  // Direct Google Gemini API uses "gemini-2.0-flash" for maximum accuracy, bilingual understanding, and zero hallucination
  ...
  const model = isGeminiDirect ? "gemini-2.0-flash" : "google/gemini-2.0-flash";
